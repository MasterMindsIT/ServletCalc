...
href="https://unpkg.com/@picocss/pico@latest/css/pico.min.css">
 ...
 <div class="field">
 <label for="Numero 1">Primer valor</label>
 <input type="number" name="numero1" placeholder="Ingresar un número entero">
 </div>
 <div class="field">
 <label for="Numero 2">Segundo valor</label>
 <input type="number" name="numero2" placeholder="Ingresar un número entero">
 </div>
